...
public class PromptUtil {
	...
	public String TPQSimple(String text) {
		...
		return String.join("", Arrays.asList(
			...
			"- 주제와 포인트 명확화: 각 Q 앞에는 P로 시작하는 포인트를, 각 대화 주제 앞에는 T로 시작하는 타이틀을 사용하여, ",
			"주제를 명확히 설정한다. 이는 TTS로 제공될 때 사용자가 각 주제를 쉽게 이해하고 기억하도록 돕는다.\n",
