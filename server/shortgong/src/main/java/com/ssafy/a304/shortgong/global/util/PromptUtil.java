...
public class PromptUtil {
	...
	public String getAnswerPrompt(String TContent, String PContent, String QContent, String text) {
		...
		return String.join("", Arrays.asList(
			...
			"반환 데이터는 각 질문(Q)에 대해 A(Answer)를 Simple, Normal, Detail의 세 가지 버전으로 작성해야 한다.\n\n",
			...
			"3가지 Answer 형식에 대해 다음과 같은 형식을 지킬 것:\n",
			...
			"입력되는 TContent, Pcontent, Qcontent와 출력되어야 하는 SA, NA, DA의 예시:\n",
			"\"T: 데이터 무결성 P: DBMS의 데이터 무결성 유지 방법 Q: DBMS는 어떻게 데이터 무결성을 유지하나요?\"일 때,\n",
			"SA: 제약 조건을 통해 무결성 유지\n",
			...
			"이제 주어진 본문 텍스트를 참고해서 SA, NA, DA를 반환하세요.\n",
			"--------------------------------\n", text, "\n--------------------------------\n\n"
		));
	}
	...
	private String getCommonAnswerRequirements() {
		...
		return String.join("", Arrays.asList(
			...
			"- 영어 알파벳을 제외한 일본어, 중국어와 같은 외국어 및 한자 등을 포함하여 반환하지 말 것.\n",
			"- SA와 NA와 DA의 마지막에 단 하나의 개행문자(\\n)를 두어 응답할 것.\n",
			"- SA, NA, DA의 사이가 아니라면, 문장과 문장 사이의 구분은 ' '의 공백만을 두어 구분할 것.\n",
